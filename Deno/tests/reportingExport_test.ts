...
function reportFixture(): OperationalReport {
  return {
    ...
    workflow: { pendingUploads: 0, pendingAccessRequests: 0 },
    activity: { uploadedEntries: 1, repositoryViews: 2, repositoryDownloads: 1, guestViews: 2, registeredViews: 0, approvedRequestDownloads: 0, activeRegisteredUsers: 0, homeVisits: { total: 1, guest: 1, registered: 0 } },
    series: { uploads: [{ bucket: "2026-08-01T16:00:00.000Z", count: 1 }], repositoryActivity: [{ bucket: "2026-08-01T16:00:00.000Z", views: 2, downloads: 1 }], homeVisits: [{ bucket: "2026-08-01T16:00:00.000Z", guest: 1, registered: 0, total: 1 }] },
    rankings: { mostViewedEntries: [{ id: 1, recordType: "document", title: "Título, with \"quotes\"\nand newline", category: "Thesis", views: 2, downloads: 1 }], mostDownloadedEntries: [], mostVisitedAuthors: [{ id: "00000000-0000-4000-8000-000000000001", name: "作者", visits: 1, profilePicture: null }], trendingTopics: [] },
    distributions: { documentTypes: [{ label: "Thesis", count: 1 }], requestStatuses: [{ status: "pending", count: 0 }, { status: "approved", count: 0 }, { status: "rejected", count: 0 }] },
